...
def test_add_featured_product_to_cart(page: Page):
    ...
    # HP LP3065 (product_id=47) is IN STOCK with no required options
    page.goto(BASE_URL + "/index.php?route=product/product&product_id=47")
